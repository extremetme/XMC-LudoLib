...
def xmcLinuxExecute(cmd): # v2 - Execute a command on XMC for which no output expected
    ...
    try:
        ...
        printLog("Error executing '{}' on XMC shell".format(cmd))
        return False

def xmcLinuxCommand(cmdRegexStr, debugKey=None): # v3 - Execute a command on XMC and recover the output
